...
forecast_location <- '/Users/quinn/Dropbox/Research/SSC_forecasting/SSC_forecasting/Forecasts' 
current_day <- '2018-08-10 00:00:00'
num_days <- 5
#--------
#   Use launch_mode <- 1 if you want to schedule the forecast to run at a certain time
#   Use launch_mode <-1 if you want to the forecast to lauch at a given time interval
#-------
launch_mode <- 1
#--------
